...
case "${1:-help}" in
    ...
    "help"|*)
        ...
        echo ""
        echo "Examples:"
        echo "  ./quick_score.sh enrich crawl_data.jsonl uptick-csvs/enriched-hubspot-TAM-08-25.csv"
        echo "  ./quick_score.sh score crawl_data.jsonl"
        echo "  ./quick_score.sh score crawl_data.jsonl results.jsonl qwen/qwen3-30b-a3b uptick-csvs/enriched-hubspot-TAM-08-25.csv"
